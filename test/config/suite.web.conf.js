...
exports.config = {
    ...
    cucumberOpts: {
        require: ['./test/stepDefinitions/given.js', './test/stepDefinitions/when.js', './test/stepDefinitions/then.js', './test/stepDefinitions/common.js', './test/stepDefinitions/curriculum.js', './test/stepDefinitions/content.js', './test/stepDefinitions/content-upload.js'],   // <string[]> (file/dir) require files before executing features
